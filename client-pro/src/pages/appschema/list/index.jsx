  ...
  const columns = [
    {
      ...
      render: (dom, entity) => {
        return (
          <a
            onClick={() => {
              history.push(`/appschemas/edit/${entity._id}`);
            }}
          >
            {dom}
          </a>
    ...
    },
    {
      ...
      valueType: 'option',
      render: (_, entity) => [
        <DeleteButton key="delete" record={entity} elementId='user-list-delete-btn' />,
        <a
          onClick={() => {
            history.push(`/dynamics/new/${entity._id}`);
          }}
        >
          Entry
        </a>,
        <a
          onClick={() => {
            history.push(`/dynamics/list/${entity._id}`);
          }}
        >
          List
        </a>
